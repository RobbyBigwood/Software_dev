...
public class PopulationPanel extends JPanel {
	...
	// in population.populate, call the setter for incubationPeriod in Person, passing the value from the MessageBoard
	public void populate() {
		Person.setIncubationPeriod(MessageBoard.incubationPeriod());
		population.populate(this);
	}
	
	public void update() {
		//Person.setMorbidity(MessageBoard.morbidityRate());
		population.update();
		repaint();
	}
