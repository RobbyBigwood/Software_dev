	...
	ActionListener checkListener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent ae) {
			...
			if (command.equals("news")) {
				newsSubscriber.subscribe(newsCheck.isSelected());
			
			} else if (command.equals("stocks")) {
				stocksSubscriber.subscribe(stocksCheck.isSelected());
			
			} else if (command.equals("weather")) {
				weatherSubscriber.subscribe(weatherCheck.isSelected());
			
			} else if (command.equals("images")) {
				imagesSubscriber.subscribe(imagesCheck.isSelected());
