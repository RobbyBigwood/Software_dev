...
public class ControlPanel extends JPanel {
	...
	protected final JLabel playClockDisplay = new JLabel();
	...
	private PlayTimeSlider playSlider;

	private ProbabilitySlider probabilitySlider;
	...
	public ControlPanel(Integer row, GameClockControl clock, GameViewingPanel gameView) {
		...
		playSlider = new PlayTimeSlider(playClock);
		playSlider.setInFrame(10, 150);
		//playSlider.setBounds(10, 150, 300, 50);
		this.add(playSlider);


		probabilitySlider = new ProbabilitySlider(gameView);
        probabilitySlider.setBounds(200, 100, 300, 50); // Adjust position and size as needed
